...
//	}
	...
	public String aboutPage(Model m) {
		...
		List list = Arrays.asList(new User(1, "java", 98654132, "ahmedabad", "abc"), new User(2, "php", 98654132, "ahmedabad", "bkj"),
				new User(3, "dart", 98654132, "ahmedabad","bhk"), new User(4, "kotlin", 98654132, "ahmedabad","kuk"),
				new User(5, "python", 98654132, "ahmedabad","fuy"));
...
//	@RequestMapping("/insert")
//	public void insertUser(@RequestParam("name") String name, @RequestParam("contact") long contact) {
//		
