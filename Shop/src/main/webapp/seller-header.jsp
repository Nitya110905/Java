                    ...
                    <div class="menu-wrapper">
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>                                                
                                <ul id="navigation">  
                                    ...
                                    <li><a href="blog.html">hi...<%=s.getName() %></a>
                                        <ul class="submenu">
                                            <li><a href="seller-change-pass.jsp">Change Password</a></li>
                                            <li><a href="sell-logout.jsp">Logout</a></li>
                                        </ul>
                                    </li>
                        ...
                        <div class="header-right">
                            <ul>
                                ...
                                <li> <a href="seller-profile.jsp"><span class="flaticon-user"></span></a></li>
