...
if(session.getAttribute("data")!=null){
	b = (buyer)session.getAttribute("data");
}
else{
                ...
                <div class="container">
                    <div class="menu-wrapper">
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>                                                
                                <ul id="navigation">  
                                    <li><a href="buyer-home.jsp">Home</a></li>
                                    ...
                                    <li><a href="blog.html">hi...<%=b.getName() %></a>
                                        <ul class="submenu">
                                            <li><a href="buyer-change-pass.jsp">Change Password</a></li>
                                            <li><a href="buy-logout.jsp">Logout</a></li>
                                        </ul>
                                    </li>
                        ...
                        <div class="header-right">
                            <ul>
                                ...
                                <li> <a href="buyer-profile.jsp"><span class="flaticon-user"></span></a></li>
                                <li class="cart"><a href="buy-cart.jsp"><span class="flaticon-shopping-cart"></span></a> </li>
                            </ul>
                        </div>
